...
const categoriesData = [
  {
    ...
    image: "/assets/img/parts/air-ride-gen-iii.jpg",
    zone: "escape",
    hotspot: { x: 22, y: 81 },
  },
  {
    ...
    image: "/assets/img/parts/air-cleaner-light-bars.jpg",
    zone: "motor",
    hotspot: { x: 47, y: 50 },
  },
  {
    ...
    image: "/assets/img/parts/air-cleaner-screens.jpg",
    zone: "motor",
    hotspot: { x: 45, y: 45 },
  },
  {
    ...
    image: "/assets/img/parts/air-cleaner-straps.jpg",
    zone: "motor",
    hotspot: { x: 45, y: 59 },
  },
  {
    ...
    image: "/assets/img/parts/air-cleaner-bar-strapless.jpg",
    zone: "motor",
    hotspot: { x: 48, y: 55 },
  },
  {
    ...
    image: "/assets/img/parts/air-cleaner-wraps.jpg",
    zone: "motor",
    hotspot: { x: 46, y: 47 },
  },
  {
    ...
    name: "AIR LINE BOX",
    slug: "air-line-box",
    image: "/assets/img/parts/air-line-box.jpg",
    zone: "escape",
    hotspot: { x: 20, y: 75 },
  },
  {
    ...
    image: "/assets/img/parts/air-tank-straps.jpg",
    zone: "escape",
    hotspot: { x: 24, y: 79 },
  },
  {
    ...
    image: "/assets/img/parts/battery-tool-boxes.jpg",
    zone: "lateral",
    hotspot: { x: 32, y: 70 },
  },
  {
    ...
    image: "/assets/img/parts/battery-tool-step-plates.jpg",
    zone: "lateral",
    hotspot: { x: 34, y: 72 },
  },
  {
    ...
    name: "BUMPERS",
    slug: "bumpers",
    image: "/assets/img/parts/bumpers.jpg",
    zone: "frontal",
    hotspot: { x: 78, y: 75 },
  },
  {
    ...
    image: "/assets/img/parts/bunk-sleeper-panels.jpg",
    zone: "sleeper",
    hotspot: { x: 38, y: 45 },
  },
  {
    ...
    image: "/assets/img/parts/cab-cowl-panels.jpg",
    zone: "superior",
    hotspot: { x: 52, y: 40 },
  },
  {
    ...
    name: "CUSTOM FLOORS",
    slug: "custom-floors",
    image: "/assets/img/parts/custom-floors.jpg",
    zone: "sleeper",
    hotspot: { x: 40, y: 50 },
  },
  {
    ...
    name: "DECK PLATES",
    slug: "deck-plates",
    image: "/assets/img/parts/deck-plates.jpg",
    zone: "sleeper",
    hotspot: { x: 42, y: 48 },
  },
  {
    ...
    name: "DPF COVERS",
    slug: "dpf-covers",
    image: "/assets/img/parts/dpf-covers.jpg",
    zone: "motor",
    hotspot: { x: 44, y: 65 },
  },
  {
    ...
    name: "FENDERS",
    slug: "fenders",
    image: "/assets/img/parts/fenders.jpg",
    zone: "lateral",
    hotspot: { x: 68, y: 85 },
  },
  {
    ...
    name: "FENDER BRACES",
    slug: "fender-braces",
    image: "/assets/img/parts/fender-braces.jpg",
    zone: "lateral",
    hotspot: { x: 70, y: 82 },
  },
  {
    ...
    name: "FLIP BUMPERS",
    slug: "flip-bumpers",
    image: "/assets/img/parts/flip-bumpers.jpg",
    zone: "frontal",
    hotspot: { x: 76, y: 78 },
  },
  {
    ...
    image: "/assets/img/parts/fuel-tank-bracket-covers.jpg",
    zone: "lateral",
    hotspot: { x: 31, y: 78 },
  },
  {
    ...
    image: "/assets/img/parts/fuel-tank-panels.jpg",
    zone: "lateral",
    hotspot: { x: 24, y: 74 },
  },
  {
    ...
    image: "/assets/img/parts/fuel-tank-straps.jpg",
    zone: "lateral",
    hotspot: { x: 26, y: 74 },
  },
  {
    ...
    image: "/assets/img/parts/fuel-tank-wraps.jpg",
    zone: "lateral",
    hotspot: { x: 28, y: 74 },
  },
  {
    ...
    name: "GRILLES",
    slug: "grilles",
    image: "/assets/img/parts/grilles.jpg",
    zone: "frontal",
    hotspot: { x: 80, y: 61 },
  },
  {
    ...
    name: "LIFT BUMPERS",
    slug: "lift-bumpers",
    image: "/assets/img/parts/lift-bumpers.jpg",
    zone: "frontal",
    hotspot: { x: 75, y: 83 },
  },
  {
    ...
    name: "LIGHT PANELS",
    slug: "light-panels",
    image: "/assets/img/parts/light-panels.jpg",
    zone: "superior",
    hotspot: { x: 8, y: 71 },
  },
  {
    ...
    image: "/assets/img/parts/mirror-brackets.jpg",
    zone: "superior",
    hotspot: { x: 40, y: 36 },
  },
  {
    ...
    image: "/assets/img/parts/overhead-consoles.jpg",
    zone: "superior",
    hotspot: { x: 55, y: 36 },
  },
  {
    ...
    name: "SHOCK BOXES",
    slug: "shock-boxes",
    image: "/assets/img/parts/shock-boxes.jpg",
    zone: "escape",
    hotspot: { x: 25, y: 60 },
  },
  {
    ...
    image: "/assets/img/parts/tail-light-bars.jpg",
    zone: "trasera",
    hotspot: { x: 8, y: 65 },
  },
  {
    ...
    name: "VISORS",
    slug: "visors",
    image: "/assets/img/parts/visors.jpg",
    zone: "superior",
    hotspot: { x: 58, y: 32 },
  },
  {
    ...
    image: "/assets/img/parts/window-accessories.jpg",
    zone: "sleeper",
    hotspot: { x: 43, y: 36 },
  },
  {
    ...
    name: "LIGHTS",
    slug: "lights",
    image: "/assets/img/parts/lights.jpg",
    zone: "frontal",
    hotspot: { x: 55, y: 27 },
  },
  {
