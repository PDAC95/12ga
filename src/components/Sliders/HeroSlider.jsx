  ...
  return (
    <section className="ak-hero-fixed ak-hero ak-style1">
      ...
      <div className="social-hero">
        {/* Instagram */}
        <a href="http://www.instagram.com" className="social-icon1">
        ...
        {/* Facebook */}
        <a href="http://www.facebook.com" className="social-icon1">
        ...
        {/* YouTube */}
        <a href="http://www.youtube.com" className="social-icon1">
          <svg xmlns="http://www.w3.org/2000/svg" width="17" height="17" viewBox="0 0 24 24" fill="none">
