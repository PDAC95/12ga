...
const TruckFilters = ({ onFiltersChange }) => {
  ...
  return (
    <div className="truck-filters">
      ...
      {/* Active Filters Display - MOVIDO AQUÍ ARRIBA */}
      {hasActiveFilters && (
        <div className="filters-container" data-aos="fade-up" data-aos-delay="50">
      ...
      <div className="filters-container" data-aos="fade-up" data-aos-delay="100">
        <div className="filters-wrapper">
          ...
          <div className="filter-group">
            ...
            <div className="custom-dropdown" style={{ position: 'relative', zIndex: '99998' }}>
              <button 
              ...
              {isDropdownOpen.make && (
                <div style={makeDropdownStyle}>
                  ...
                  {truckData.makes.map((make) => (
                    <div 
                      key={make.id}
                      style={filters.make === make.name ? selectedItemStyle : dropdownItemStyle}
                      onClick={() => handleFilterChange('make', make.name)}
                      onMouseEnter={(e) => handleItemHover(e, false, filters.make === make.name)}
                      onMouseLeave={(e) => handleItemHover(e, true, filters.make === make.name)}
                    >
                      {make.name}
                    </div>
                  ))}
              ...
              {isDropdownOpen.year && (
                <div style={yearDropdownStyle}>
                  ...
                  {truckData.years.map((year) => (
                    <div 
                      key={year}
                      style={filters.year === year.toString() ? selectedItemStyle : dropdownItemStyle}
                      onClick={() => handleFilterChange('year', year.toString())}
                      onMouseEnter={(e) => handleItemHover(e, false, filters.year === year.toString())}
                      onMouseLeave={(e) => handleItemHover(e, true, filters.year === year.toString())}
                    >
                      {year}
                    </div>
                  ))}
