...
const TruckCard = ({ truck, viewMode = "grid" }) => {
  ...
  // Get the correct slug or fallback to id
  const truckSlug = truck.slug || truck.id;
  const truckImage =
    truck.image || truck.images?.[0] || "/assets/img/trucks/default-truck.jpg";
  const truckTitle = truck.title || truck.name || "Custom Truck Build";
      ...
      <div className="truck-card truck-card-list">
          ...
          <div className="image-wrapper">
            ...
            {imageError ? (
              <div className="image-error">
                ...
                >
                  <path
                    d="M14.5 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2-2V7.5L14.5 2z"
                    stroke="currentColor"
                    strokeWidth="2"
                  />
                  <polyline
            ...
            <div className="image-overlay">
              <div className="overlay-content">
                <Link to={`/truck/${truckSlug}`} className="view-details-btn">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="20"
                    height="20"
        ...
        <div className="truck-card-content">
          ...
          <h3 className="truck-title">
            <Link to={`/truck/${truckSlug}`}>{truckTitle}</Link>
          </h3>
          ...
          <div className="truck-card-footer">
            ...
            <Link to={`/truck/${truckSlug}`} className="details-link">
              View Project
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="16"
  ...
  return (
    <div className="truck-card truck-card-grid">
      ...
      <div className="truck-card-content">
        ...
        <h3 className="truck-title">
          <Link to={`/truck/${truckSlug}`}>
            {viewMode === "grid" ? truncateText(truckTitle, 30) : truckTitle}
          </Link>
        </h3>
